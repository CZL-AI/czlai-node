...
import { APIUserAbortError } from 'czlai';
import { Headers } from 'czlai/core';
...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['CZLAI_BASE_URL'] = undefined;
    });
    ...
    test('env variable', () => {
      process.env['CZLAI_BASE_URL'] = 'https://example.com/from_env';
      const client = new Czlai({
        bearerToken: 'My Bearer Token',
        username: 'My Username',
        password: 'My Password',
    ...
    test('empty env variable', () => {
      process.env['CZLAI_BASE_URL'] = ''; // empty
      const client = new Czlai({
        bearerToken: 'My Bearer Token',
        username: 'My Username',
        password: 'My Password',
      });
      expect(client.baseURL).toEqual('/api/v1.0/ai-b');
    });

    test('blank env variable', () => {
      process.env['CZLAI_BASE_URL'] = '  '; // blank
      const client = new Czlai({
        bearerToken: 'My Bearer Token',
        username: 'My Username',
        password: 'My Password',
